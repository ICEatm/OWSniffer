...
namespace OWSniffer
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // Setting Title
            Console.Title = "OWSniffer - darby#9820";
            ...
            Console.WriteLine("\n> Welcome to the Overwatch Demo Sniffer!");
            Console.WriteLine("> This tool will give you the download link for your overwatch cases!\n");
